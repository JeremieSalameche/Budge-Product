<template>
  <div class="login-page">
    ...
    <div class="login-left">
      <div class="login-left__glow login-left__glow--1"></div>
      <div class="login-left__glow login-left__glow--2"></div>
      ...
      <div class="login-left__content">
        <h2 class="login-left__title">Votre budget.<br>Sous contrôle.</h2>
        <p class="login-left__sub">Visualisez, partagez et maîtrisez<br>vos dépenses en temps réel.</p>
      </div>
    </div>
...
/* Glows dégradé rose-violet-bleu */
.login-left__glow {
  position: absolute;
  border-radius: 50%;
  filter: blur(80px);
