        ...
        <div v-if="infoOpen" class="eq-panel__overlay" @click.self="infoOpen = false">
          <div class="eq-panel eq-info-panel">
            <div class="eq-panel__header">
              <div>
                <div class="eq-panel__title">Le score d'équité</div>
                <div class="eq-panel__sub">Comment lire ce chiffre ?</div>
              </div>
            ...
            <div class="eq-panel__body eq-info-body">
              ...
              <p class="eq-info-intro">Le score mesure si chacun paie une part des charges <strong>proportionnelle à ce qu'il gagne</strong>. Plus le partage est juste, plus le score est proche de 100.</p>
