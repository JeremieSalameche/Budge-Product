  ...
  <div id="app">
    ...
    <aside class="sidebar">
      <div class="sidebar__logo">
        ...
        <span class="sidebar__brand">Budget</span>
      </div>
          ...
          <div class="header-pills">
            ...
            >
              <button
                ...
                :style="{ borderColor: openPopover === p.id ? '#18181B' : p.couleur + '40', color: openPopover === p.id ? '#FAFAFA' : p.couleur, background: openPopover === p.id ? '#18181B' : '#FAFAFA' }"
...
const navItems = [
  ...
  { id: 'enveloppes', label: 'Répartitions',
