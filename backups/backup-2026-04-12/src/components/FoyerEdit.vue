        ...
        <div class="fe__body">
          ...
          <div class="fe__section fe__section--membres">
            ...
            <div v-for="(p, i) in personnes" :key="i" class="fe__membre">
              ...
              <button
                v-if="type === 'personnalise' && personnes.length > 1"
                class="fe__remove-btn" type="button" @click="retirerPersonne(i)"
              >
            ...
            <button v-if="type === 'personnalise' && personnes.length < 6" class="fe__add-btn" type="button" @click="ajouterPersonne">
...
function detectType(personnes) {
  ...
  if (personnes.length === 2) return 'couple'
  return 'personnalise'
}
